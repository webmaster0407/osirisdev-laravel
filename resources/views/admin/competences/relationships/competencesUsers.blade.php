...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-competencesUsers">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.user.fields.competences') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($users as $key => $user)
                        <tr data-entry-id="{{ $user->id }}">
                            ...
                            <td>
                                @foreach($user->competences as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-competencesUsers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
