...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.prev.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.prevs.update", [$prev->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.prev.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $prev->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('prevtype') ? 'is-invalid' : '' }}" name="prevtype" id="prevtype" required>
                    ...
                    @foreach(App\Models\Prev::PREVTYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('prevtype', $prev->prevtype) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $prev->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('internalinfo') ? 'is-invalid' : '' }}" name="internalinfo" id="internalinfo">{!! old('internalinfo', $prev->internalinfo) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $prev->date) }}" required>
                @if($errors->has('date'))
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('starttime') ? 'is-invalid' : '' }}" type="text" name="starttime" id="starttime" value="{{ old('starttime', $prev->starttime) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('endtime') ? 'is-invalid' : '' }}" type="text" name="endtime" id="endtime" value="{{ old('endtime', $prev->endtime) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('rvtime') ? 'is-invalid' : '' }}" type="text" name="rvtime" id="rvtime" value="{{ old('rvtime', $prev->rvtime) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('location') ? 'is-invalid' : '' }}" name="location_id" id="location_id">
                    @foreach($locations as $id => $entry)
                        <option value="{{ $id }}" {{ (old('location_id') ? old('location_id') : $prev->location->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('created_by') ? 'is-invalid' : '' }}" name="created_by_id" id="created_by_id" required>
                    @foreach($created_bies as $id => $entry)
                        <option value="{{ $id }}" {{ (old('created_by_id') ? old('created_by_id') : $prev->created_by->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('papyrus') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="papyrus" id="papyrus" value="1" {{ $prev->papyrus || old('papyrus', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('prima') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="prima" id="prima" value="1" {{ $prev->prima || old('prima', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('prevresponsible') ? 'is-invalid' : '' }}" name="prevresponsible_id" id="prevresponsible_id">
                    @foreach($prevresponsibles as $id => $entry)
                        <option value="{{ $id }}" {{ (old('prevresponsible_id') ? old('prevresponsible_id') : $prev->prevresponsible->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="number" name="amount" id="amount" value="{{ old('amount', $prev->amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cares') ? 'is-invalid' : '' }}" type="number" name="cares" id="cares" value="{{ old('cares', $prev->cares) }}" step="1">
                @if($errors->has('cares'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ambulancetransports') ? 'is-invalid' : '' }}" type="number" name="ambulancetransports" id="ambulancetransports" value="{{ old('ambulancetransports', $prev->ambulancetransports) }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('report') ? 'is-invalid' : '' }}" name="report" id="report">{!! old('report', $prev->report) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    ...
                    @foreach(App\Models\Prev::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $prev->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
