    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-assigneduserTasks">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($tasks as $key => $task)
                            <tr data-entry-id="{{ $task->id }}">
                                ...
                                <td>
                                    <span style="display:none">{{ $task->completed ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-assigneduserTasks:not(.ajaxTable)').DataTable({ buttons: dtButtons })
