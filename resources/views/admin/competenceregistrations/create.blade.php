...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.competenceregistration.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.competenceregistrations.store") }}" enctype="multipart/form-data">
            @csrf
