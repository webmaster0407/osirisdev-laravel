                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Note::VISABILITY_SELECT as $key => $item)
...
{ data: 'id', name: 'id' },
{ data: 'userid_firstname', name: 'userid.firstname' },
{ data: 'userid.name', name: 'userid.name' },
{ data: 'userid.email', name: 'userid.email' },
{ data: 'note', name: 'note' },
{ data: 'relationtype', name: 'relationtype' },
{ data: 'relationid', name: 'relationid' },
{ data: 'visability', name: 'visability' },
